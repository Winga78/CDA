...
VITE_SOCKET_CHAT_SERVICE_URL=http://${aws_lb.application_load_balancer.dns_name}/posts
...
VITE_SOCKET_VOTE_SERVICE_URL=http://${aws_lb.application_load_balancer.dns_name}/post-user
EOF
}