...
resource "aws_ecs_task_definition" "default" {
  ...
  container_definitions = jsonencode([
    ...
    environment = [
     ...
     { name = "VITE_SOCKET_CHAT_SERVICE_URL",  value = "http://${aws_lb.application_load_balancer.dns_name}/chat" },
     ...
     { name = "VITE_SOCKET_VOTE_SERVICE_URL",  value = "http://${aws_lb.application_load_balancer.dns_name}/vote" },
